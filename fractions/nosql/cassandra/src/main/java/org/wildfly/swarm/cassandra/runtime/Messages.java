...
public interface Messages extends BasicLogger {
    ...
    Messages MESSAGES = Logger.getMessageLogger(Messages.class, "org.wildfly.swarm.cassandra");
    ...
    @Message(id = OFFSET + 4, value = "Cannot specify NoSQL module '%s' " +
                "when module '%s' is already being used")
